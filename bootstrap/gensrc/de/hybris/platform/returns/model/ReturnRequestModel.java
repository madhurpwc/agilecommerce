...
public class ReturnRequestModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>ReturnRequest.deliveryDocNumbers</code> attribute defined at extension <code>sapreturnsexchange</code>. */
	public static final String DELIVERYDOCNUMBERS = "deliveryDocNumbers";
	
	/** <i>Generated constant</i> - Attribute key of <code>ReturnRequest.reasonCodeCancellation</code> attribute defined at extension <code>sapreturnsexchange</code>. */
	public static final String REASONCODECANCELLATION = "reasonCodeCancellation";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ReturnRequest.deliveryDocNumbers</code> attribute defined at extension <code>sapreturnsexchange</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the deliveryDocNumbers - holds delivery document numbers from SAP system
	 */
	@Accessor(qualifier = "deliveryDocNumbers", type = Accessor.Type.GETTER)
	public List<String> getDeliveryDocNumbers()
	{
		return getPersistenceContext().getPropertyValue(DELIVERYDOCNUMBERS);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ReturnRequest.reasonCodeCancellation</code> attribute defined at extension <code>sapreturnsexchange</code>. 
	 * @return the reasonCodeCancellation - Reason Code For Cancellation
	 */
	@Accessor(qualifier = "reasonCodeCancellation", type = Accessor.Type.GETTER)
	public String getReasonCodeCancellation()
	{
		return getPersistenceContext().getPropertyValue(REASONCODECANCELLATION);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ReturnRequest.deliveryDocNumbers</code> attribute defined at extension <code>sapreturnsexchange</code>. 
	 *  
	 * @param value the deliveryDocNumbers - holds delivery document numbers from SAP system
	 */
	@Accessor(qualifier = "deliveryDocNumbers", type = Accessor.Type.SETTER)
	public void setDeliveryDocNumbers(final List<String> value)
	{
		getPersistenceContext().setPropertyValue(DELIVERYDOCNUMBERS, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ReturnRequest.reasonCodeCancellation</code> attribute defined at extension <code>sapreturnsexchange</code>. 
	 *  
	 * @param value the reasonCodeCancellation - Reason Code For Cancellation
	 */
	@Accessor(qualifier = "reasonCodeCancellation", type = Accessor.Type.SETTER)
	public void setReasonCodeCancellation(final String value)
	{
		getPersistenceContext().setPropertyValue(REASONCODECANCELLATION, value);
	}
