...
public class ClassificationAttributeUnitModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>ClassificationAttributeUnit.sapCode</code> attribute defined at extension <code>sapmodel</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ClassificationAttributeUnit.sapCode</code> attribute defined at extension <code>sapmodel</code>. 
	 * @return the sapCode - SAP Code (ERP Table T006 field MSEHI)
	 */
	@Accessor(qualifier = "sapCode", type = Accessor.Type.GETTER)
	public String getSapCode()
	{
		return getPersistenceContext().getPropertyValue(SAPCODE);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ClassificationAttributeUnit.sapCode</code> attribute defined at extension <code>sapmodel</code>. 
	 *  
	 * @param value the sapCode - SAP Code (ERP Table T006 field MSEHI)
	 */
	@Accessor(qualifier = "sapCode", type = Accessor.Type.SETTER)
	public void setSapCode(final String value)
	{
