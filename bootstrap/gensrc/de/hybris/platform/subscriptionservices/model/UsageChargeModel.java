...
public class UsageChargeModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>UsageCharge.blockSize</code> attribute defined at extension <code>saprevenuecloudproduct</code>. */
	public static final String BLOCKSIZE = "blockSize";
	
	/** <i>Generated constant</i> - Attribute key of <code>UsageCharge.minBlocks</code> attribute defined at extension <code>saprevenuecloudproduct</code>. */
	public static final String MINBLOCKS = "minBlocks";
	
	/** <i>Generated constant</i> - Attribute key of <code>UsageCharge.subscriptionBillingId</code> attribute defined at extension <code>saprevenuecloudproduct</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>UsageCharge.blockSize</code> attribute defined at extension <code>saprevenuecloudproduct</code>. 
	 * @return the blockSize - Block size
	 */
	@Accessor(qualifier = "blockSize", type = Accessor.Type.GETTER)
	public Integer getBlockSize()
	{
		return getPersistenceContext().getPropertyValue(BLOCKSIZE);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>UsageCharge.minBlocks</code> attribute defined at extension <code>saprevenuecloudproduct</code>. 
	 * @return the minBlocks - Minimum blocks
	 */
	@Accessor(qualifier = "minBlocks", type = Accessor.Type.GETTER)
	public Integer getMinBlocks()
	{
		return getPersistenceContext().getPropertyValue(MINBLOCKS);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>UsageCharge.subscriptionBillingId</code> attribute defined at extension <code>saprevenuecloudproduct</code>. 
	...
	/**
	 * <i>Generated method</i> - Setter of <code>UsageCharge.blockSize</code> attribute defined at extension <code>saprevenuecloudproduct</code>. 
	 *  
	 * @param value the blockSize - Block size
	 */
	@Accessor(qualifier = "blockSize", type = Accessor.Type.SETTER)
	public void setBlockSize(final Integer value)
	{
		getPersistenceContext().setPropertyValue(BLOCKSIZE, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>UsageCharge.minBlocks</code> attribute defined at extension <code>saprevenuecloudproduct</code>. 
	 *  
	 * @param value the minBlocks - Minimum blocks
	 */
	@Accessor(qualifier = "minBlocks", type = Accessor.Type.SETTER)
	public void setMinBlocks(final Integer value)
	{
		getPersistenceContext().setPropertyValue(MINBLOCKS, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>UsageCharge.subscriptionBillingId</code> attribute defined at extension <code>saprevenuecloudproduct</code>. 
	 *  
