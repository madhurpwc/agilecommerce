...
public class B2BCustomerModel extends CustomerModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>B2BCustomer.sapBusinessPartnerID</code> attribute defined at extension <code>sapcpicustomerexchangeb2b</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>B2BCustomer.sapBusinessPartnerID</code> attribute defined at extension <code>sapcpicustomerexchangeb2b</code>. 
	 * @return the sapBusinessPartnerID - SAP Business Partner ID
	 */
	@Accessor(qualifier = "sapBusinessPartnerID", type = Accessor.Type.GETTER)
	public String getSapBusinessPartnerID()
	{
		return getPersistenceContext().getPropertyValue(SAPBUSINESSPARTNERID);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>B2BCustomer.sapBusinessPartnerID</code> attribute defined at extension <code>sapcpicustomerexchangeb2b</code>. 
	 *  
	 * @param value the sapBusinessPartnerID - SAP Business Partner ID
	 */
	@Accessor(qualifier = "sapBusinessPartnerID", type = Accessor.Type.SETTER)
	public void setSapBusinessPartnerID(final String value)
	{
