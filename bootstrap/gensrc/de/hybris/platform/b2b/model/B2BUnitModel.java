...
public class B2BUnitModel extends OrgUnitModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>B2BUnit.revenueCloudCompanyId</code> attribute defined at extension <code>saprevenuecloudcustomer</code>. */
	public static final String REVENUECLOUDCOMPANYID = "revenueCloudCompanyId";
	
	/** <i>Generated constant</i> - Attribute key of <code>B2BUnit.areYouSupplier</code> attribute defined at extension <code>c4hisb2ccore</code>. */
	public static final String AREYOUSUPPLIER = "areYouSupplier";
	
	/** <i>Generated constant</i> - Attribute key of <code>B2BUnit.areYouDistributor</code> attribute defined at extension <code>c4hisb2ccore</code>. */
	public static final String AREYOUDISTRIBUTOR = "areYouDistributor";
	
	/** <i>Generated constant</i> - Attribute key of <code>B2BUnit.distributors</code> attribute defined at extension <code>c4hisb2ccore</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>B2BUnit.areYouDistributor</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 * @return the areYouDistributor - Are you a Distributor
	 */
	@Accessor(qualifier = "areYouDistributor", type = Accessor.Type.GETTER)
	public Boolean getAreYouDistributor()
	{
		return getPersistenceContext().getPropertyValue(AREYOUDISTRIBUTOR);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>B2BUnit.areYouSupplier</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 * @return the areYouSupplier - Are you a Supplier
	 */
	@Accessor(qualifier = "areYouSupplier", type = Accessor.Type.GETTER)
	public Boolean getAreYouSupplier()
	{
		return getPersistenceContext().getPropertyValue(AREYOUSUPPLIER);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>B2BUnit.distributors</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the distributors
	 */
	@Accessor(qualifier = "distributors", type = Accessor.Type.GETTER)
	public Collection<VendorModel> getDistributors()
	{
		return getPersistenceContext().getPropertyValue(DISTRIBUTORS);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>B2BUnit.revenueCloudCompanyId</code> attribute defined at extension <code>saprevenuecloudcustomer</code>. 
	 * @return the revenueCloudCompanyId - Company ID from the Revenue Cloud system.
	 */
	@Accessor(qualifier = "revenueCloudCompanyId", type = Accessor.Type.GETTER)
	public String getRevenueCloudCompanyId()
	{
		return getPersistenceContext().getPropertyValue(REVENUECLOUDCOMPANYID);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>B2BUnit.areYouDistributor</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 *  
	 * @param value the areYouDistributor - Are you a Distributor
	 */
	@Accessor(qualifier = "areYouDistributor", type = Accessor.Type.SETTER)
	public void setAreYouDistributor(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(AREYOUDISTRIBUTOR, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>B2BUnit.areYouSupplier</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 *  
	 * @param value the areYouSupplier - Are you a Supplier
	 */
	@Accessor(qualifier = "areYouSupplier", type = Accessor.Type.SETTER)
	public void setAreYouSupplier(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(AREYOUSUPPLIER, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>B2BUnit.distributors</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 *  
	 * @param value the distributors
	 */
	@Accessor(qualifier = "distributors", type = Accessor.Type.SETTER)
	public void setDistributors(final Collection<VendorModel> value)
	{
		getPersistenceContext().setPropertyValue(DISTRIBUTORS, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>B2BUnit.revenueCloudCompanyId</code> attribute defined at extension <code>saprevenuecloudcustomer</code>. 
	 *  
	 * @param value the revenueCloudCompanyId - Company ID from the Revenue Cloud system.
	 */
	@Accessor(qualifier = "revenueCloudCompanyId", type = Accessor.Type.SETTER)
	public void setRevenueCloudCompanyId(final String value)
	{
		getPersistenceContext().setPropertyValue(REVENUECLOUDCOMPANYID, value);
	}
