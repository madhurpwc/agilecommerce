...
public class AbstractRuleModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractRule.sapConditionType</code> attribute defined at extension <code>saporderexchange</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractRule.sapConditionType</code> attribute defined at extension <code>saporderexchange</code>. 
	 * @return the sapConditionType - SAP Condition Type
	 */
	@Accessor(qualifier = "sapConditionType", type = Accessor.Type.GETTER)
	public String getSapConditionType()
	{
		return getPersistenceContext().getPropertyValue(SAPCONDITIONTYPE);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractRule.sapConditionType</code> attribute defined at extension <code>saporderexchange</code>. 
	 *  
	 * @param value the sapConditionType - SAP Condition Type
	 */
	@Accessor(qualifier = "sapConditionType", type = Accessor.Type.SETTER)
	public void setSapConditionType(final String value)
	{
