...
public class CommentModel extends AbstractCommentModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Comment.cpqCommentAuthorEmail</code> attribute defined at extension <code>sapcpqquoteintegration</code>. */
	public static final String CPQCOMMENTAUTHOREMAIL = "cpqCommentAuthorEmail";
	
	/** <i>Generated constant</i> - Attribute key of <code>Comment.source</code> attribute defined at extension <code>sapcpqquoteintegration</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Comment.cpqCommentAuthorEmail</code> attribute defined at extension <code>sapcpqquoteintegration</code>. 
	 * @return the cpqCommentAuthorEmail - Temporary placeholder to map Author of comments
	 */
	@Accessor(qualifier = "cpqCommentAuthorEmail", type = Accessor.Type.GETTER)
	public String getCpqCommentAuthorEmail()
	{
		return getPersistenceContext().getPropertyValue(CPQCOMMENTAUTHOREMAIL);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Comment.source</code> attribute defined at extension <code>sapcpqquoteintegration</code>. 
	 * @return the source - Temporary place to map source to comments
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Comment.cpqCommentAuthorEmail</code> attribute defined at extension <code>sapcpqquoteintegration</code>. 
	 *  
	 * @param value the cpqCommentAuthorEmail - Temporary placeholder to map Author of comments
	 */
	@Accessor(qualifier = "cpqCommentAuthorEmail", type = Accessor.Type.SETTER)
	public void setCpqCommentAuthorEmail(final String value)
	{
		getPersistenceContext().setPropertyValue(CPQCOMMENTAUTHOREMAIL, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Comment.source</code> attribute defined at extension <code>sapcpqquoteintegration</code>. 
	 *  
	 * @param value the source - Temporary place to map source to comments
	 */
