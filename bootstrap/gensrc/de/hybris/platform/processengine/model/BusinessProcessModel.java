...
public class BusinessProcessModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>BusinessProcess.cpqEmailAttachments</code> attribute defined at extension <code>sapcpqquoteintegration</code>. */
	public static final String CPQEMAILATTACHMENTS = "cpqEmailAttachments";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BusinessProcess.cpqEmailAttachments</code> attribute defined at extension <code>sapcpqquoteintegration</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the cpqEmailAttachments
	 */
	@Accessor(qualifier = "cpqEmailAttachments", type = Accessor.Type.GETTER)
	public List<EmailAttachmentModel> getCpqEmailAttachments()
	{
		return getPersistenceContext().getPropertyValue(CPQEMAILATTACHMENTS);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BusinessProcess.cpqEmailAttachments</code> attribute defined at extension <code>sapcpqquoteintegration</code>. 
	 *  
	 * @param value the cpqEmailAttachments
	 */
	@Accessor(qualifier = "cpqEmailAttachments", type = Accessor.Type.SETTER)
	public void setCpqEmailAttachments(final List<EmailAttachmentModel> value)
	{
		getPersistenceContext().setPropertyValue(CPQEMAILATTACHMENTS, value);
	}
