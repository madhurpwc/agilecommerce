...
public class ConsignmentModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Consignment.sapOrder</code> attribute defined at extension <code>sapmodel</code>. */
	public static final String SAPORDER = "sapOrder";
	
	/** <i>Generated constant</i> - Attribute key of <code>Consignment.sapConsignmentProcesses</code> attribute defined at extension <code>saporderexchangeoms</code>. */
	public static final String SAPCONSIGNMENTPROCESSES = "sapConsignmentProcesses";
	
	/** <i>Generated constant</i> - Attribute key of <code>Consignment.subscriptionProducts</code> attribute defined at extension <code>saprevenuecloudorder</code>. */
	 ...
	 * @param _sapOrder initial attribute declared by type <code>Consignment</code> at extension <code>sapmodel</code>
	 * @param _shippingAddress initial attribute declared by type <code>Consignment</code> at extension <code>basecommerce</code>
	 * @param _status initial attribute declared by type <code>Consignment</code> at extension <code>basecommerce</code>
	 * @param _warehouse initial attribute declared by type <code>Consignment</code> at extension <code>basecommerce</code>
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public ConsignmentModel(final String _code, final DeliveryModeModel _deliveryMode, final Date _namedDeliveryDate, final AbstractOrderModel _order, final ItemModel _owner, final SAPOrderModel _sapOrder, final AddressModel _shippingAddress, final ConsignmentStatus _status, final WarehouseModel _warehouse)
	{
		super();
		setCode(_code);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Consignment.sapConsignmentProcesses</code> attribute defined at extension <code>saporderexchangeoms</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the sapConsignmentProcesses
	 */
	@Accessor(qualifier = "sapConsignmentProcesses", type = Accessor.Type.GETTER)
	public Collection<SapConsignmentProcessModel> getSapConsignmentProcesses()
	{
		return getPersistenceContext().getPropertyValue(SAPCONSIGNMENTPROCESSES);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Consignment.sapOrder</code> attribute defined at extension <code>sapmodel</code>. 
	 * @return the sapOrder
	 */
	@Accessor(qualifier = "sapOrder", type = Accessor.Type.GETTER)
	public SAPOrderModel getSapOrder()
	{
		return getPersistenceContext().getPropertyValue(SAPORDER);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Consignment.subscriptionProducts</code> attribute defined at extension <code>saprevenuecloudorder</code>. 
	 * @return the subscriptionProducts - sets subscription products flag on consignment
	 */
	@Accessor(qualifier = "subscriptionProducts", type = Accessor.Type.GETTER)
	public boolean isSubscriptionProducts()
	{
		return toPrimitive((Boolean)getPersistenceContext().getPropertyValue(SUBSCRIPTIONPRODUCTS));
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Consignment.sapConsignmentProcesses</code> attribute defined at extension <code>saporderexchangeoms</code>. 
	 *  
	 * @param value the sapConsignmentProcesses
	 */
	@Accessor(qualifier = "sapConsignmentProcesses", type = Accessor.Type.SETTER)
	public void setSapConsignmentProcesses(final Collection<SapConsignmentProcessModel> value)
	{
		getPersistenceContext().setPropertyValue(SAPCONSIGNMENTPROCESSES, value);
	}
	
	/**
	 * <i>Generated method</i> - Initial setter of <code>Consignment.sapOrder</code> attribute defined at extension <code>sapmodel</code>. Can only be used at creation of model - before first save.  
	 *  
	 * @param value the sapOrder
	 */
	@Accessor(qualifier = "sapOrder", type = Accessor.Type.SETTER)
	public void setSapOrder(final SAPOrderModel value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Consignment.subscriptionProducts</code> attribute defined at extension <code>saprevenuecloudorder</code>. 
	 *  
	 * @param value the subscriptionProducts - sets subscription products flag on consignment
	 */
	@Accessor(qualifier = "subscriptionProducts", type = Accessor.Type.SETTER)
	public void setSubscriptionProducts(final boolean value)
	{
		getPersistenceContext().setPropertyValue(SUBSCRIPTIONPRODUCTS, toObject(value));
	}
