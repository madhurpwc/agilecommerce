...
import de.hybris.platform.sap.saprevenuecloudorder.model.SAPSubscriptionConfigurationModel;
...
public class WarehouseModel extends ItemModel
{
	...
	/**<i>Generated relation code constant for relation <code>SapProductPlantRelation</code> defining source attribute <code>Product</code> in extension <code>sapmodel</code>.</i>*/
	public static final String _SAPPRODUCTPLANTRELATION = "SapProductPlantRelation";
	
	/**<i>Generated relation code constant for relation <code>SAPPlantLogSysOrg2WarehouseRelation</code> defining source attribute <code>sapPlantLogSysOrg</code> in extension <code>sapmodel</code>.</i>*/
	public static final String _SAPPLANTLOGSYSORG2WAREHOUSERELATION = "SAPPlantLogSysOrg2WarehouseRelation";
	
	/**<i>Generated relation code constant for relation <code>SAPSubscriptionConfiguration2WarehouseRelation</code> defining source attribute <code>sapSubscriptionConfig</code> in extension <code>saprevenuecloudorder</code>.</i>*/
	public static final String _SAPSUBSCRIPTIONCONFIGURATION2WAREHOUSERELATION = "SAPSubscriptionConfiguration2WarehouseRelation";
	...
	/** <i>Generated constant</i> - Attribute key of <code>Warehouse.Product</code> attribute defined at extension <code>sapmodel</code>. */
	public static final String PRODUCT = "Product";
	
	/** <i>Generated constant</i> - Attribute key of <code>Warehouse.sapPlantLogSysOrg</code> attribute defined at extension <code>sapmodel</code>. */
	public static final String SAPPLANTLOGSYSORG = "sapPlantLogSysOrg";
	
	/** <i>Generated constant</i> - Attribute key of <code>Warehouse.sapSubscriptionConfig</code> attribute defined at extension <code>saprevenuecloudorder</code>. */
	public static final String SAPSUBSCRIPTIONCONFIG = "sapSubscriptionConfig";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Warehouse.sapPlantLogSysOrg</code> attribute defined at extension <code>sapmodel</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Warehouse.sapSubscriptionConfig</code> attribute defined at extension <code>saprevenuecloudorder</code>. 
	 * @return the sapSubscriptionConfig
	 */
	@Accessor(qualifier = "sapSubscriptionConfig", type = Accessor.Type.GETTER)
	public SAPSubscriptionConfigurationModel getSapSubscriptionConfig()
	{
		return getPersistenceContext().getPropertyValue(SAPSUBSCRIPTIONCONFIG);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Warehouse.sapPlantLogSysOrg</code> attribute defined at extension <code>sapmodel</code>. 
	 *  
	 * @param value the sapPlantLogSysOrg
	 */
	@Accessor(qualifier = "sapPlantLogSysOrg", type = Accessor.Type.SETTER)
	public void setSapPlantLogSysOrg(final SAPPlantLogSysOrgModel value)
	{
		getPersistenceContext().setPropertyValue(SAPPLANTLOGSYSORG, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Warehouse.sapSubscriptionConfig</code> attribute defined at extension <code>saprevenuecloudorder</code>. 
	 *  
	 * @param value the sapSubscriptionConfig
	 */
	@Accessor(qualifier = "sapSubscriptionConfig", type = Accessor.Type.SETTER)
	public void setSapSubscriptionConfig(final SAPSubscriptionConfigurationModel value)
	{
		getPersistenceContext().setPropertyValue(SAPSUBSCRIPTIONCONFIG, value);
	}
