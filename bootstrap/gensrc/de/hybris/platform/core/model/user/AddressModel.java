...
public class AddressModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Address.sapAddressUUID</code> attribute defined at extension <code>sapcpiadapter</code>. */
	...
	/** <i>Generated constant</i> - Attribute key of <code>Address.sapCustomerID</code> attribute defined at extension <code>sapmodel</code>. */
	public static final String SAPCUSTOMERID = "sapCustomerID";
	
	/** <i>Generated constant</i> - Attribute key of <code>Address.sapAddressUsage</code> attribute defined at extension <code>sapmodel</code>. */
	public static final String SAPADDRESSUSAGE = "sapAddressUsage";
	
	/** <i>Generated constant</i> - Attribute key of <code>Address.sapAddressUsageCounter</code> attribute defined at extension <code>sapmodel</code>. */
	public static final String SAPADDRESSUSAGECOUNTER = "sapAddressUsageCounter";
	
	/** <i>Generated constant</i> - Attribute key of <code>Address.sapMessageFunction</code> attribute defined at extension <code>sapcpicustomerexchangeb2b</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.sapAddressUsage</code> attribute defined at extension <code>sapmodel</code>. 
	...
	{
		return getPersistenceContext().getPropertyValue(SAPADDRESSUSAGE);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.sapAddressUsageCounter</code> attribute defined at extension <code>sapmodel</code>. 
	...
	{
		return getPersistenceContext().getPropertyValue(SAPADDRESSUSAGECOUNTER);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.sapAddressUUID</code> attribute defined at extension <code>sapcpiadapter</code>. 
	...
	{
		return getPersistenceContext().getPropertyValue(SAPADDRESSUUID);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.sapCustomerID</code> attribute defined at extension <code>sapmodel</code>. 
	...
	{
		return getPersistenceContext().getPropertyValue(SAPCUSTOMERID);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Address.sapMessageFunction</code> attribute defined at extension <code>sapcpicustomerexchangeb2b</code>. 
	 * @return the sapMessageFunction
	 */
	@Accessor(qualifier = "sapMessageFunction", type = Accessor.Type.GETTER)
	public String getSapMessageFunction()
	{
		return getPersistenceContext().getPropertyValue(SAPMESSAGEFUNCTION);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Address.sapAddressUsage</code> attribute defined at extension <code>sapmodel</code>. 
	 *  
	 * @param value the sapAddressUsage - SAP address usage
	 */
	@Accessor(qualifier = "sapAddressUsage", type = Accessor.Type.SETTER)
	public void setSapAddressUsage(final String value)
	{
		getPersistenceContext().setPropertyValue(SAPADDRESSUSAGE, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Address.sapAddressUsageCounter</code> attribute defined at extension <code>sapmodel</code>. 
	 *  
	...
	public void setSapAddressUsageCounter(final String value)
	{
		getPersistenceContext().setPropertyValue(SAPADDRESSUSAGECOUNTER, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Address.sapAddressUUID</code> attribute defined at extension <code>sapcpiadapter</code>. 
	 *  
	 * @param value the sapAddressUUID - SAP Address UUID
	 */
	@Accessor(qualifier = "sapAddressUUID", type = Accessor.Type.SETTER)
	public void setSapAddressUUID(final String value)
	{
		getPersistenceContext().setPropertyValue(SAPADDRESSUUID, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Address.sapCustomerID</code> attribute defined at extension <code>sapmodel</code>. 
	 *  
	...
	public void setSapCustomerID(final String value)
	{
		getPersistenceContext().setPropertyValue(SAPCUSTOMERID, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Address.sapMessageFunction</code> attribute defined at extension <code>sapcpicustomerexchangeb2b</code>. 
	 *  
	 * @param value the sapMessageFunction
	 */
	@Accessor(qualifier = "sapMessageFunction", type = Accessor.Type.SETTER)
	public void setSapMessageFunction(final String value)
	{
