...
public class AbstractOrderModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrder.orderType</code> attribute defined at extension <code>c4hisb2ccore</code>. */
	public static final String ORDERTYPE = "orderType";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrder.vendorSelected</code> attribute defined at extension <code>c4hisb2ccore</code>. */
	public static final String VENDORSELECTED = "vendorSelected";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrder.invoiceNumber</code> attribute defined at extension <code>c4hisb2ccore</code>. */
	public static final String INVOICENUMBER = "invoiceNumber";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrder.revenueCloudOrderId</code> attribute defined at extension <code>saprevenuecloudorder</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.invoiceNumber</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 * @return the invoiceNumber
	 */
	@Accessor(qualifier = "invoiceNumber", type = Accessor.Type.GETTER)
	public String getInvoiceNumber()
	{
		return getPersistenceContext().getPropertyValue(INVOICENUMBER);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.orderType</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 * @return the orderType - This field stores the type of the cart/order such as STANDARD, DROPSHIP, OTHER etc.
	 */
	@Accessor(qualifier = "orderType", type = Accessor.Type.GETTER)
	public C4HISProductType getOrderType()
	{
		return getPersistenceContext().getPropertyValue(ORDERTYPE);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.revenueCloudOrderId</code> attribute defined at extension <code>saprevenuecloudorder</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.vendorSelected</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 * @return the vendorSelected
	 */
	@Accessor(qualifier = "vendorSelected", type = Accessor.Type.GETTER)
	public VendorModel getVendorSelected()
	{
		return getPersistenceContext().getPropertyValue(VENDORSELECTED);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.invoiceNumber</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 *  
	 * @param value the invoiceNumber
	 */
	@Accessor(qualifier = "invoiceNumber", type = Accessor.Type.SETTER)
	public void setInvoiceNumber(final String value)
	{
		getPersistenceContext().setPropertyValue(INVOICENUMBER, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.orderType</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 *  
	 * @param value the orderType - This field stores the type of the cart/order such as STANDARD, DROPSHIP, OTHER etc.
	 */
	@Accessor(qualifier = "orderType", type = Accessor.Type.SETTER)
	public void setOrderType(final C4HISProductType value)
	{
		getPersistenceContext().setPropertyValue(ORDERTYPE, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.revenueCloudOrderId</code> attribute defined at extension <code>saprevenuecloudorder</code>. 
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.vendorSelected</code> attribute defined at extension <code>c4hisb2ccore</code>. 
	 *  
	 * @param value the vendorSelected
	 */
	@Accessor(qualifier = "vendorSelected", type = Accessor.Type.SETTER)
	public void setVendorSelected(final VendorModel value)
	{
		getPersistenceContext().setPropertyValue(VENDORSELECTED, value);
	}
