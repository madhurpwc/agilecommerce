...
public class PerUnitUsageChargeEntryModel extends UsageChargeEntryModel
{
	/**<i>Generated model type code constant.</i>*/
	public static final String _TYPECODE = "PerUnitUsageChargeEntry";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public PerUnitUsageChargeEntryModel()
	{
		super();
	}
	 ...
	 */
	public PerUnitUsageChargeEntryModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public PerUnitUsageChargeEntryModel(final Double _price)
	{
		super();
		setPrice(_price);
	}
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public PerUnitUsageChargeEntryModel(final CatalogVersionModel _catalogVersion, final String _id, final ItemModel _owner, final Double _price)
	{
		super();
